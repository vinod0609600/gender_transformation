      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
            <div className="space-y-8">
              ...
              <div className="grid gap-6">
                {[
                  ...
                  <div key={i} className="flex gap-4 p-4 rounded-xl bg-white/60 backdrop-blur-sm border hover:shadow-sm transition-shadow">
            ...
            <div className="bg-secondary/20 p-8 rounded-2xl border h-fit">
